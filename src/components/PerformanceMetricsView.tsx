...
const mockData = [
  { agentCode: 'agent_001', timestamp: '2025-12-12 10:30:00', value: 98.5, status: 'Success' },
  { agentCode: 'agent_002', timestamp: '2025-12-12 10:25:00', value: 97.2, status: 'Success' },
  { agentCode: 'agent_003', timestamp: '2025-12-12 10:20:00', value: 99.1, status: 'Success' },
  { agentCode: 'agent_001', timestamp: '2025-12-12 10:15:00', value: 96.8, status: 'Success' },
  { agentCode: 'agent_004', timestamp: '2025-12-12 10:10:00', value: 95.3, status: 'Success' },
  { agentCode: 'agent_002', timestamp: '2025-12-12 10:05:00', value: 98.0, status: 'Success' },
  { agentCode: 'agent_005', timestamp: '2025-12-12 10:00:00', value: 97.5, status: 'Success' },
  { agentCode: 'agent_003', timestamp: '2025-12-12 09:55:00', value: 96.2, status: 'Success' },
];
...
export function PerformanceMetricsView() {
  ...
  const handleFetch = () => {
    toast.success('Fetching performance metrics...');
  ...
  return (
    <div className="max-w-[1400px] mx-auto px-8 py-8">
      ...
      <div className="flex items-center gap-2 text-sm mb-6">
        ...
        <span className="text-[#999]">/</span>
        <span className="text-[#333]">Performance</span>
      </div>

      {/* Header */}
      <div className="bg-white rounded-xl shadow-md p-6 mb-6">
        <h1 className="text-[#333] mb-6">Agent Metrics [Performance]</h1>
      ...
      {/* All Aggregated Performance Table */}
      <div className="bg-white rounded-xl shadow-md p-6">
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-[#333]">All Aggregated Performance</h3>
            ...
            <tbody>
              {data.map((row, index) => (
                <tr key={index} className="border-b border-[#eee] hover:bg-[#f8f5ff] transition-colors">
                  ...
                  <td className="px-4 py-3 text-right text-[#333] font-medium">{row.value.toFixed(1)}%</td>
